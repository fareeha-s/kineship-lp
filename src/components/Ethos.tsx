...
export default function Ethos({ isOpen, onClose }: { isOpen: boolean, onClose: () => void }) {
  ...
  return (
    <AnimatePresence>
      {isOpen && (
        <div className="fixed inset-0 flex items-center lg:items-start lg:justify-start justify-center z-[60] overflow-y-auto">
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
          ...
          <FocusTrap focusTrapOptions={{ initialFocus: false }}>
            <motion.div
              ...
              className="relative mx-auto lg:ml-[8%] my-8 lg:my-24 w-[90vw] lg:w-[45vw] max-w-2xl z-[70]
            ...
            >
              ...
              <div className="relative text-white/90 lowercase font-inter">
                ...
                >
                  {currentSlide === 0 && "we believe connection blooms through simple shared rhythms."}
                  ...
                  {currentSlide === 1 && (
                    <>
                      ...
                      <p className="leading-relaxed mt-0">
                        our mission is to fundamentally shift how we grow our relationships - a key driver of lifespan. <span className="font-bold">it's time for alternatives to our usual social defaults</span>.
                      </p>
                      <p className="leading-relaxed mt-4">
                        the data is clear: while our gatherings often revolve around abundant food, drinks, and late nights, <span className="font-bold">we can choose to build a culture built on health</span>.
                      </p>
                    </>
                  )}
